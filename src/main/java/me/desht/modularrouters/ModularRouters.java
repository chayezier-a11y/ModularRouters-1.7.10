...
import me.desht.modularrouters.event.MiscEventHandler;
...
public class ModularRouters {
    ...
    private void setupNetwork() {
        ...
        network.registerMessage(ModuleDirectionMessage.Handler.class, ModuleDirectionMessage.class, d++, Side.SERVER);
        network.registerMessage(ModuleConfigMessage.Handler.class, ModuleConfigMessage.class, d++, Side.SERVER);
        network.registerMessage(ModuleFlagsMessage.Handler.class, ModuleFlagsMessage.class, d++, Side.SERVER);
        network.registerMessage(RouterUpgradesSyncMessage.Handler.class, RouterUpgradesSyncMessage.class, d++, Side.CLIENT);
    }
}
